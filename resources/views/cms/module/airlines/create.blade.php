                  ...
                  <div class="card-body">
                    <form class="forms-sample" method="POST" action="{{ route('airlines.store') }}">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-select" id="exampleSelectGender" name="country" required>
